...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "⌯  𝐐𝐮𝐫𝐚𝐧 .𓍯")

OWNER_ID = list(map(int, getenv("OWNER_ID", "1095638828 5488301592").split()))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/hsiwudhswid8d/bbb",
)
...
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/VY_GROUP")
